...
function EsqueceuSenha() {
  ...
  const enviarFormulario = (e) => {
    ...
    if (objUsuario.emailId.trim() === "")
      return setMensagemErro(
        "O campo Email é obrigatório! (use qualquer valor)",
      );
    else {
      setCarregando(true);
            ...
            {!linkEnviado && (
              <>
                ...
                <form onSubmit={(e) => enviarFormulario(e)}>
                  <div className="mb-4">
                    <InputText
                      type="emailId" // Alterado de "emailId" para "email", a menos que "emailId" seja um tipo personalizado em seu componente
                      value={objUsuario.emailId}
                      updateType="emailId"
                      containerStyle="mt-4"
                      labelTitle="Email"
